...
def reset_model_selection(request, pk: int) -> bool:
...
def set_model_selection_name(request, pk: int) -> None:
...
def set_model_selection(request, pk: int) -> None:
...
def toggle_model_selection(request, pk: int) -> None:
