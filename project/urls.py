...
urlpatterns = [
    ...
    path("settings/<int:pk>/edit", ProjectUpdateSettingsView.as_view(), name="project_update_settings"),
    path("<int:pk>/model", ProjectListModelView.as_view(), name="project_list_model"),
    path("<int:pk>/model/create", ProjectCreateModelView.as_view(), name="project_create_model"),
    path("model/<int:pk>/edit", ProjectUpdateModelView.as_view(), name="project_update_model"),
    path("model/<int:pk>/delete", ProjectDeleteSettingsView.as_view(), name="project_delete_model"),
    path("model/<int:pk>/select", ProjectSelectModelView.as_view(), name="project_select_model"),
    ]
